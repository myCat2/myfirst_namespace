...
<head id="Head1">
    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						...
						},{"menuid":"3","icon":"icon-sys","menuname":"员工管理",
							"menus":[
								{"menuid":"31","menuname":"员工列表","icon":"icon-users","url":"${pageContext.request.contextPath}/view/admin/empInfoManage.jsp"}
								]
						},{"menuid":"4","icon":"icon-sys","menuname":" 职务管理",
							"menus":[
								{"menuid":"41","menuname":"人员列表","icon":"icon-users","url":"${pageContext.request.contextPath}/view/admin/roleInfoManage.jsp"}
								]
						...
						},{"menuid":"6","icon":"icon-sys","menuname":" 采购管理",
							"menus":[
								{"menuid":"61","menuname":"采购审批","icon":"icon-users","url":"${pageContext.request.contextPath}/book/reviewapplication.jsp"}
								]
						},{"menuid":"7","icon":"icon-sys","menuname":" 统计信息",
							"menus":[
								{"menuid":"71","menuname":"员工男女比例饼状图","icon":"icon-users","url":"${pageContext.request.contextPath}/view/admin/SexEcharts.jsp"},
								{"menuid":"72","menuname":"员工入职时间折线图","icon":"icon-users","url":"${pageContext.request.contextPath}/view/admin/EntryDateEcharts.jsp"}
								]
						}
